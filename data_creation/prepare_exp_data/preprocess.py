...
class DocumentState(object):
    ...
    def finalize(self):
        ...
        #     mention_set = set(all_mentions)
        #     temp_mentions = deepcopy(all_mentions)
        #     for token in mention_set:
        #         temp_mentions.pop(token)
        #     print("Wrong")
...
def get_document(doc_key, doc_lines, language, seg_len, tokenizer):
    ...
    for i, line in enumerate(doc_lines):
        ...
        if len(row) == 0:
            # print(document_state.sentence_end)
            # print(doc_key, i)
            # print(line)
